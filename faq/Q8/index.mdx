...
---
   ...
   * On confirmation from the Virtual Labs team on the workshop date (as filled in the Expression of
     Interest), download a checklist [[https://docs.google.com/document/d/1CvHfQTX331oEJlaXvQHaqjY2y8q_Esj5FFDs3hOG36Q/edit][form]] and  mail the duly fill/scanned form to [[mailto:ioc-iiith@vlabs.ac.in][ioc-iiith@vlabs.ac.in]]
